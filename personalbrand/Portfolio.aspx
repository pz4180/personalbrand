...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container">
        ...
        <div class="gallery-grid">
            ...
            <div class="gallery-item" data-category="cakes">
                <img src="Images/cake2.jpg" alt="Chocolate Layer Cake" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="cakes">
                <img src="Images/cake3.jpg" alt="Red Velvet Cake" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="breads">
                <img src="Images/croiss.jpg" alt="Croissants" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="breads">
                <img src="Images/bague.jpg" alt="Baguettes" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="pastries">
                <img src="Images/eclairs.jpg" alt="Eclairs" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="pastries">
                <img src="Images/puff.jpg" alt="Cream Puffs" loading="lazy" />
                <div class="caption">
                    <h3>Cream Puffs</h3>
            ...
            <div class="gallery-item" data-category="breads">
                <img src="Images/brioche.jpg" alt="Brioche" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="cakes">
                <img src="Images/cake4.jpg" alt="Tiramisu Cake" loading="lazy" />
                <div class="caption">
                    <h3>Tiramisu Cake</h3>
            ...
            <div class="gallery-item" data-category="cakes">
                <img src="Images/cake5.jpg" alt="Birthday Cake" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="pastries">
                <img src="Images/lemon.jpg" alt="Lemon Tart" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="breads">
                <img src="Images/dough.jpg" alt="Sourdough" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="pastries">
                <img src="Images/mille.jpg" alt="Mille-feuille" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="cakes">
                <img src="Images/cheese.jpg" alt="Cheesecake" loading="lazy" />
                <div class="caption">
            ...
            <div class="gallery-item" data-category="breads">
                <img src="Images/roll.jpg" alt="Cinnamon Rolls" loading="lazy" />
                <div class="caption">
